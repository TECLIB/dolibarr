...
/**
 *  \file       advanceddiscount_note.php
 *  \ingroup    advanceddiscount
 *  \brief      Car with notes on AdvancedDiscount
 */
...
$langs->loadLangs(array("advanceddiscount@advanceddiscount","companies"));
...
if ($id > 0 || ! empty($ref)) $upload_dir = $conf->advanceddiscount->multidir_output[$object->entity] . "/" . $object->id;

$permissionnote=1;
//$permissionnote=$user->rights->advanceddiscount->creer;	// Used by the include of actions_setnotes.inc.php
...
$help_url='';
llxHeader('',$langs->trans('AdvancedDiscount'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("AdvancedDiscount"), -1, 'advanceddiscount@advanceddiscount');
