...
/**
 *  \file       advanceddiscount_agenda.php
 *  \ingroup    advanceddiscount
 *  \brief      Page of AdvancedDiscount events
 */
...
$hookmanager->initHooks(array('advanceddiscountagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("AdvancedDiscount"), -1, 'advanceddiscount@advanceddiscount');
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOnAdvancedDiscount"),'','');
