...
/**
 *	\file       htdocs/advanceddiscount/template/advanceddiscountindex.php
 *	\ingroup    advanceddiscount
 *	\brief      Home page of advanceddiscount top menu
 */
...
$langs->loadLangs(array("advanceddiscount@advanceddiscount"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->hasRight('advanceddiscount', 'read')) accessforbidden();
...
llxHeader("",$langs->trans("AdvancedDiscountArea"));

print load_fiche_titre($langs->trans("AdvancedDiscountArea"),'','advanceddiscount.png@advanceddiscount');
...
// Draft MyObject
if (! empty($conf->advanceddiscount->enabled) && $user->rights->advanceddiscount->read)
{
	$langs->load("orders");
