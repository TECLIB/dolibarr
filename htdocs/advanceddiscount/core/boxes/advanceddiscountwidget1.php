...
/**
 * \file    modulebuilder/template/core/boxes/advanceddiscountwidget1.php
 * \ingroup advanceddiscount
 * \brief   Widget provided by AdvancedDiscount
 *
 ...
 */
class advanceddiscountwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "advanceddiscountbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "advanceddiscount@advanceddiscount";
	 ...
	 */
	public $depends = array('advanceddiscount');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->advanceddiscount->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/advanceddiscount/class/advanceddiscount.class.php";

		// Populate the head at runtime
		$text = $langs->trans("AdvancedDiscountBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_advanceddiscount@advanceddiscount',
