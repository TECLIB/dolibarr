...
/**
 * \file    test/functional/AdvancedDiscountFunctionalTest.php
...
/**
 * Class AdvancedDiscountFunctionalTest
 *
 ...
 *
 * @package Testadvanceddiscount
 */
class AdvancedDiscountFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAdvancedDiscount')->click();
		} else {
			// Disable the module
			$this->byHref('modAdvancedDiscount')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/advanceddiscount/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('advanceddiscount/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/advanceddiscount/admin/about.php');
		$this->authenticate();
		return $this->assertContains('advanceddiscount/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('advanceddiscountwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAdvancedDiscount_AdvancedDiscountTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAdvancedDiscount_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
