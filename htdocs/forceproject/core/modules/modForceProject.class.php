...
/**
 *	\file       htdocs/forceproject/core/modules/modForceProject.class.php
 *	\ingroup    forceproject
 *	\brief      Descriptor of module ForceProject
 */

include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");

/**
 *	Description and activation class for module modActions
 */
class modForceProject extends DolibarrModules
{
	/**
	...
	function __construct($DB)
	{
		...
		$this->rights_class = 'forceproject';
		...
		$this->description = "Check a project is linked to allow to validate proposal or order. It may also replace key 'projectref' or {PROJECTREF-X} (with X = length of project ref) with ref of linked project if found into ref.";
		...
		$this->picto='teclib@forceproject';
		...
		$this->config_page_url = array("forceproject.php@forceproject");
		...
		// Constants
		//$this->const=array(0=>array('FORCEPROJECT_ON_ALL','chaine','1','Force project on all element','allentities'));
		$this->const=array();
