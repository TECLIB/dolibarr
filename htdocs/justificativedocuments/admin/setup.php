...
$page_name = "JustificativeDocumentsSetup";
llxHeader('', $langs->trans($page_name));

// Subheader
$linkback = '<a href="'.($backtopage?$backtopage:DOL_URL_ROOT.'/admin/modules.php?restore_lastsearch_values=1').'">'.$langs->trans("BackToModuleList").'</a>';

print load_fiche_titre($langs->trans($page_name), $linkback, 'object_justificativedocuments@justificativedocuments');

// Configuration header
$head = justificativedocumentsAdminPrepareHead();
dol_fiche_head($head, 'settings', '', -1, "justificativedocuments@justificativedocuments");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("JustificativeDocumentsSetupPage").'</span><br><br>';
