...
/**
 * \file       htdocs/core/modules/justificativedocument/mod_justificativedocument_advanced.php
 ...
 */
class mod_justificativedocument_advanced extends ModeleNumRefjustificativedocuments
{
	/**
     * Dolibarr version of the loaded document
     * @var string
     */
	public $version = 'development';		// 'development', 'experimental', 'dolibarr'
    ...
    public function info()
    {
		...
		$texte.= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="maskBom" value="' . getDolGlobalString('BOM_ADVANCED_MASK').'">', $tooltip, 1, 1).'</td>';
    ...
    public function getNextValue($objprod, $object)
    {
		...
		// We get cursor rule
		$mask=$conf->global->JUSTIFICATIVEDOCUMENT_ADVANCED_MASK;
