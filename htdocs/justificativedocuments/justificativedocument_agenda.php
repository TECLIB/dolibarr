...
/**
 *  \file       justificativedocument_agenda.php
 *  \ingroup    justificativedocuments
 *  \brief      Page of JustificativeDocument events
 */
...
$hookmanager->initHooks(array('justificativedocumentagenda','globalcard'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("JustificativeDocument"), -1, $object->picto);
