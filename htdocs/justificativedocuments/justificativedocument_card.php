	...
	*/
	...
	if ($action != 'presend' && $action != 'editline') {
    	...
    	if (empty($reshook))
    	{
    		...
    		// Clone
    		if ($permissiontoadd) {
    			//print dolGetButtonAction($langs->trans("ToClone"), '', 'default', $_SERVER['PHP_SELF'].'?id='.$object->id.'&socid='.$object->socid.'&action=clone&object=bom', 'justificativedocument', $permissiontoadd);
    		}
