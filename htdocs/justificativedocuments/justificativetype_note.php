...
/**
 *  \file       justificativetype_note.php
 *  \ingroup    justificativedocuments
 *  \brief      Car with notes on JustificativeType
 */
...
$langs->loadLangs(array("justificativedocuments@justificativedocuments","companies"));
...
$hookmanager->initHooks(array('justificativetypenote','globalcard'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('', $langs->trans('JustificativeType'), $help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("JustificativeType"), -1, $object->picto);
