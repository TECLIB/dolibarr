...
class KimiosDB{
   ...
   **/
   function addToDB() {
      ...
      if ($nb_fields>0) {
         ...
         dol_syslog("Kimios_DB::addToDB::".$query, LOG_INFO);
   ...
   **/
   function getFromDB ($ID) {
      ...
      dol_syslog("Kimios_DB::getFromDB::".$query, LOG_INFO);
   ...
   **/
   function find ($condition="", $order="", $limit="") {
      ...
      dol_syslog("Kimios_DB::find::".$query, LOG_INFO);
   ...
   function updateInDB($updates, $oldvalues=array()) {
      ...
      foreach ($updates as $field) {
         if (isset($this->fields[$field])) {
            ...
            dol_syslog("Kimios_DB::updateInDB::".$query, LOG_INFO);
   ...
   **/
   function deleteFromDB() {
      ...
      $query = "DELETE
                FROM `".$this->getTable()."`
                WHERE `".$indexName."` = '".$this->fields[$indexName]."'";
